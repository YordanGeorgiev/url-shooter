# sfw/bash/url-shooter/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat docs/txt/url-shooter/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: sfw/bash/url-shooter/funcs/create-relative-7z-package.spec.sh
