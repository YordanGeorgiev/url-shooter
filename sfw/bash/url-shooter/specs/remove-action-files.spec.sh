# sfw/bash/url-shooter/funcs/remove-action-files.spec.sh
...
doSpecRemoveActionFiles(){
	...
	cat docs/txt/url-shooter/specs/remove-action-files.spec.txt
...
# eof file: sfw/bash/url-shooter/funcs/remove-action-files.spec.sh
